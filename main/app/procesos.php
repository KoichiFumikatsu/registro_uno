		...
		<div class="card">
			<div class="card-body">
              ...
              <div class="list-group">
                <button type="button" class="list-group-item list-group-item-action">Registro Agente de Servicio</button>
                <button type="button" class="list-group-item list-group-item-action">Registro Abogado Bilingue</button>
                <button type="button" class="list-group-item list-group-item-action">Registro Interprete</button>
                <button type="button" class="list-group-item list-group-item-action">Registro Abogado Laboralista/Litigante/Comercial/Administracion</button>
