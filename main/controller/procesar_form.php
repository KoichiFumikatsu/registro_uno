...
try {
    ...
    $sql = "INSERT INTO t_employee (type_CC, CC, first_Name, second_Name, first_LastName, second_LastName, email, phone, country, city, company, position)
            VALUES (:type_CC, :CC, :first_Name, :second_Name, :first_LastName, :second_LastName, :email, :phone, :country, :city, :company, :position)";
